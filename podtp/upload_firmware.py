...
from .podtp_packet import PODTP_MAX_DATA_LEN
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--ip', help='IP address of the ESP32', type=str, required=True)
    parser.add_argument('-p', '--port', help='Port of the ESP32', type=int, default=80)
    parser.add_argument('-f', '--file', help='Binary file to upload', type=str, required=True)
